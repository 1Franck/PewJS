 ...
 */
var layerOptions = { autoresize: true };
var layerA = game.createLayer('background', layerOptions),
    layerB = game.createLayer('foreground', layerOptions);
